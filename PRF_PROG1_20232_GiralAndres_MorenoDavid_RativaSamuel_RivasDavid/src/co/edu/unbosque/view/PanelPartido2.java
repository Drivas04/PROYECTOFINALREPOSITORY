...
public class PanelPartido2 extends JPanel{
	...
	public static final String LOCAL="local2";
	public static final String EMPATE="empate2";
	public static final String VISITANTE="visitante2";
	
	public PanelPartido2(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 2");
