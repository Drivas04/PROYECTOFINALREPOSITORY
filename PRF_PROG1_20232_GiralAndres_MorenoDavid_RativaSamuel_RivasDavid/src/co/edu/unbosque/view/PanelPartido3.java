...
public class PanelPartido3 extends JPanel{
	...
	public static final String LOCAL="local3";
	public static final String EMPATE="empate3";
	public static final String VISITANTE="visitante3";
	
	public PanelPartido3(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 3");
