...
public class PanelPartido4 extends JPanel{
	...
	public static final String LOCAL="local4";
	public static final String EMPATE="empate4";
	public static final String VISITANTE="visitante4";
	
	public PanelPartido4(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 4");
