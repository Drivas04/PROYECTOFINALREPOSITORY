...
public class PanelPartido7 extends JPanel{
	...
	public static final String LOCAL="local7";
	public static final String EMPATE="empate7";
	public static final String VISITANTE="visitante7";
	
	public PanelPartido7(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 7");
