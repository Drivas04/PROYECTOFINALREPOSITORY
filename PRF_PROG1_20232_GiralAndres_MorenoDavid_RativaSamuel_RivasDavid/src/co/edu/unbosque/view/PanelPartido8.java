...
public class PanelPartido8 extends JPanel{
	...
	public static final String LOCAL="local8";
	public static final String EMPATE="empate8";
	public static final String VISITANTE="visitante8";
	
	public PanelPartido8(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 8");
