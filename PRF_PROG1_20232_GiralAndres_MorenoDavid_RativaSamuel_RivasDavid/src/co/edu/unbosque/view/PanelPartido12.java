...
public class PanelPartido12 extends JPanel{
	...
	public static final String LOCAL="local12";
	public static final String EMPATE="empate12";
	public static final String VISITANTE="visitante12";
	
	public PanelPartido12(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 12");
