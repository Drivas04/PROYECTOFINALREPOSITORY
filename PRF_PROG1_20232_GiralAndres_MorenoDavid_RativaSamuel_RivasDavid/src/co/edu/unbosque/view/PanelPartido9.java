...
public class PanelPartido9 extends JPanel{
	...
	public static final String LOCAL="local9";
	public static final String EMPATE="empate9";
	public static final String VISITANTE="visitante9";
	
	public PanelPartido9(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 9");
