...
public class PanelPartido14 extends JPanel{
	...
	public static final String LOCAL="local14";
	public static final String EMPATE="empate14";
	public static final String VISITANTE="visitante14";
	
	public PanelPartido14(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 14");
