...
public class PanelPartido13 extends JPanel{
	...
	public static final String LOCAL="local13";
	public static final String EMPATE="empate13";
	public static final String VISITANTE="visitante13";
	
	public PanelPartido13(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 13");
