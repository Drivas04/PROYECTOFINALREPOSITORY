...
public class PanelPartido5 extends JPanel{
	...
	public static final String LOCAL="local5";
	public static final String EMPATE="empate5";
	public static final String VISITANTE="visitante5";
	
	public PanelPartido5(String ruta) {
		fondo = new ImageIcon(ruta);
		TitledBorder border = BorderFactory.createTitledBorder("Elija un ganador del partido 5");
